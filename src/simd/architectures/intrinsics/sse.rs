...
impl SimdBitwiseImpl for SseReg {
    ...
    #[inline(always)]
    fn not(self) -> Self {
        Self(self.xor(Self::splat_32(!0)).0)
    }
    #[inline(always)]
...
impl SimdVariableBlendImpl for SseReg {
    type VecType = Self;
    #[inline(always)]
    fn vblend_64(self, true_values: Self::VecType, false_values: Self::VecType) -> Self {
        self_from_op!(_mm_blendv_pd, false_values, true_values, self)
    }
    #[inline(always)]
    fn vblend_32(self, true_values: Self::VecType, false_values: Self::VecType) -> Self {
        self_from_op!(_mm_blendv_ps, false_values, true_values, self)
    }
    #[inline(always)]
    fn vblend_8(self, true_values: Self::VecType, false_values: Self::VecType) -> Self {
...
impl SimdNegateImpl for SseReg {
    ...
    fn negate_f64(self) -> Self {
        Self::splat_64(-0.0f64).xor(self)
    }
    #[inline(always)]
    fn negate_f32(self) -> Self {
        Self::splat_32(-0.0f64).xor(self)
    }
}
...
impl SimdMaskBitConversion for SseReg {
    ...
    fn from_bits_16(bitmask: u64) -> Self {
        ...
        self_from_op!(_mm_cmpeq_epi16, bits.and(mask), Self::zero()).not()
    }
    #[inline(always)]
    fn from_bits_8(bitmask: u64) -> Self {
        ...
        self_from_op!(_mm_cmpeq_epi8, bits.and(mask), Self::zero()).not()
    }
}
