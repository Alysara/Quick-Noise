...
//
// type SimplexContainer2D<const N: usize> = [Vec2<SimdArray<f32, N>>; 3];
// // pub struct SimplexContainer2D<const N: usize> {
// //     vecs: [Vec2<SimdArray<f32, N>>; 3],
// //     lo: usize,
// //     mi: usize,
// //     hi: usize,
// // }
// //
// // impl<const N: usize> SimplexContainer2D<N> {
...
// //     }
// //
// //     pub fn lo(&self) -> &Vec2<SimdArray<f32, N>> {
// //         unsafe { &self.vecs.get_unchecked(self.lo) }
// //     }
// //     pub fn mi(&self) -> &Vec2<SimdArray<f32, N>> {
// //         unsafe { &self.vecs.get_unchecked(self.mi) }
// //     }
// //     pub fn hi(&self) -> &Vec2<SimdArray<f32, N>> {
// //         unsafe { &self.vecs.get_unchecked(self.hi) }
// //     }
// //
...
// // ————————————————————————————————————————————————————————————————
//
// pub struct SimplexGridNoise2D<const X: usize, const Y: usize, const N: usize> {}
//
// const NUM_BLOCKS: usize = NUM_SIMD_REG / 8;
// const LANES: usize = ArchSimd::<f32>::LANES;
// const BLOCK_LANES: usize = NUM_BLOCKS * LANES;
//
// impl<const X: usize, const Y: usize, const N: usize> SimplexGridNoise2D<X, Y, N> {
...
//         let frac = block_pos.as_f32() * increment;
//
...
//         let mut d_vecs: SimplexContainer2D<X> = unsafe { SimplexContainer2D::new_uninit() };
//
...
//         gradients: &SimplexContainer2D<X>,
//         y_frac_start: f32,
//         y_increment: f32,
