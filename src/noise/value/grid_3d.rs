...
pub const NUM_BLOCKS: usize = NUM_SIMD_REG / 4;
...
#[inline(always)]
pub(super) fn grid_trilerp<F: Fractal, const INIT: bool, const FINAL: bool>(
...
impl<'a, F: Fractal, const INIT: bool, const FINAL: bool> DottedTrilerpExecuter<'a, F, INIT, FINAL> {
    #[inline(always)]
