...
impl BatchNoise for Cellular {
    ...
    fn batch_3d(
        ...
        if !is_far.all_false() {
            ...
            let z_dist_tlff = (((hash_tlff << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo;
            let z_dist_ttlf = (((hash_ttlf << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo;
            let z_dist_tllf = (((hash_tllf << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo + one;
            let z_dist_trff = (((hash_trff << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi;
            let z_dist_ttrf = (((hash_ttrf << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi;
            let z_dist_trrf = (((hash_trrf << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi - one;
            let z_dist_blff = (((hash_blff << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo;
            let z_dist_bblf = (((hash_bblf << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo;
            let z_dist_bllf = (((hash_bllf << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo + one;
            let z_dist_brff = (((hash_brff << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi;
            let z_dist_bbrf = (((hash_bbrf << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi;
            let z_dist_brrf = (((hash_brrf << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi - one;
            let z_dist_tlbb = (((hash_tlbb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo;
            let z_dist_ttlb = (((hash_ttlb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo;
            let z_dist_tllb = (((hash_tllb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo + one;
            let z_dist_trbb = (((hash_trbb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi;
            let z_dist_ttrb = (((hash_ttrb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi;
            let z_dist_trrb = (((hash_trrb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi - one;
            let z_dist_blbb = (((hash_blbb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo;
            let z_dist_bblb = (((hash_bblb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo;
            let z_dist_bllb = (((hash_bllb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() + z_dist_lo + one;
            let z_dist_brbb = (((hash_brbb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi;
            let z_dist_bbrb = (((hash_bbrb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi;
            let z_dist_brrb = (((hash_brrb << 12) & hash_mask) | exp_bits).raw_cast::<f32>() - z_dist_hi - one;
