...
fn main() -> grayscale::GrayscaleWriteResult<()> {
    ...
    grayscale::write_perlin_heightmap_batched("noise_images/batched_pass.png", 32, 1.0 / 32.0)?;
    grayscale::write_simplex_heightmap_batched("noise_images/simplex_batched.png", 32, 1.0 / 64.0)?;
    grayscale::write_value_heightmap_batched("noise_images/value_batched.png", 32, 1.0 / 32.0)?;
    grayscale::write_worley_heightmap_batched("noise_images/worley_batched.png", 32, 1.0 / 64.0)?;
    grayscale::write_perlin_heightmap_batched_3d(
        "noise_images/batched_pass_3d.png",
        32,
        1.0 / 32.0,
    )?;
    grayscale::write_value_heightmap_batched_3d(
        "noise_images/batched_value_3d.png",
        32,
        1.0 / 16.0,
    )?;
    grayscale::write_cellular_heightmap_batched_3d(
        "noise_images/batched_cellular_3d.png",
        32,
        1.0 / 32.0,
    )?;
    grayscale::write_simplex_heightmap_batched_3d(
        "noise_images/batched_simplex_3d.png",
        32,
        1.0 / 64.0,
    )?;

    grayscale::write_perlin_heightmap_3d(
        "noise_images/single_pass_3d.png",
        256,
        8,
        600.,
        1.9,
    ...
    grayscale::write_perlin_heightmap("noise_images/glossy.png", 32, 11, 256.0, 1.5, 0.7)?;
    grayscale::write_perlin_heightmap("noise_images/chiseled.png", 32, 6, 256.0, 2.0, 0.8)?;
    grayscale::write_perlin_heightmap("noise_images/smooth.png", 32, 20, 512.0, 1.2, 0.9)?;
    grayscale::write_perlin_heightmap("noise_images/sharp.png", 32, 6, 64.0, 2.0, 0.9)?;

    // For more control, determine the scale and weight of each octave:
    grayscale::write_perlin_octaves_heightmap(
    ...
    grayscale::write_perlin_heightmap_3d("noise_images/single_pass_3d.png", 32, 1, 32.0, 2.0, 0.5)?;
